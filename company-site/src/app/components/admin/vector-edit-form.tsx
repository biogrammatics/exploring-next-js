...
interface VectorEditFormProps {
  vector: VectorData;
  promoters: SelectOption[];
  selectionMarkers: SelectOption[];
  vectorTypes: SelectOption[];
  hostOrganisms: SelectOption[];
  productStatuses: SelectOption[];
  updateAction: (formData: FormData) => Promise<void>;
}

export function VectorEditForm({
  vector,
  promoters,
  selectionMarkers,
  vectorTypes,
